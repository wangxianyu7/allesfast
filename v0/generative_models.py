...
#::: my modules
from allesfast.exoworlds_rdx.lightcurves import lightcurve_tools as lct
...
#::: translate physical parameters to ellc parameters
###############################################################################
def translate_physical_to_allesfast(period = 1., 
                                      R_companion = 1., M_companion = 1.,
                                      R_companion_unit = 'Rearth', M_companion_unit = 'Mearth',
                                      R_host = 1., M_host = 1., 
                                      incl = 90, 
...
def make_lc_model(time, 
    ...
    rr, rsuma, cosi, a, f_c, f_s, ldc_transformed = translate_physical_to_allesfast(period = period, R_companion = R_companion, M_companion = M_companion, R_companion_unit = R_companion_unit, M_companion_unit = M_companion_unit, R_host = R_host, M_host = M_host, incl = incl, ecc = ecc, omega = omega)   
